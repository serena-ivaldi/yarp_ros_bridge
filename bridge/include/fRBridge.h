...
protected:
    ...
    std::string topicName; /**< Name of the ROS topic (used as input) */
    std::string yarpPort; /**< Name of the YARP port (used as output) */
...
*/
    FRBridge(int* _fd, std::string _topicName, std::string _yarpPort);
