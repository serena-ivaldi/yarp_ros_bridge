...
*/
class ConvertModule: public yarp::os::RFModule
{

private:
    std::string name; /**< Name of the module */
    std::string bridgeType; /**< Type of the bridge (yarp2ros or ros2yarp) */
    std::string yarpPort; /**< Port used for YARP, either for input or output */
    std::string rosTopic; /**< Topic used for ROS, either for input or output */
    ...
    std::unique_ptr<ConvertThread> thread; /**< A pointer to a ConvertThread. Only used for YARP->ROS */
    std::unique_ptr<FRBridge> fRBridge; /**< A pointer to a FRDataBridge. Only used for ROS->YARP */
...
*/
    bool checkPort(std::string devicePort, int dataType);
...
*/
    void compileRosNodes(std::string lastActualEdit, int dataType);
...
*/
    bool checkUpdate(yarp::os::ResourceFinder &rf, std::string &lastActualEdit);
...
*/
    void getTypeString(yarp::os::Bottle& b, std::string root, int &size, std::string &str);
...
*/
    std::string addPart(std::string type, std::string name, int code);
