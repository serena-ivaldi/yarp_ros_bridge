...
*/
    FRDataBridge(int* _fd, std::string _topicName, std::string _yarpPort, field _rosGroups);
...
*/
    bool boolStringToInt(std::string str);
...
*/
    int getYarpTypeInt(std::string type);
...
*/
    std::vector<std::pair<std::string,unsigned>> processIncomingData(const std::string &receivedData);
};
