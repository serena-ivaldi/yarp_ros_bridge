...
private:
    ...
    yarp::os::BufferedPort<ImageOf<PixelRgb>> imagePort; /**< The port connected to the device port to gather image from the camera */
...
*/
    FRImageBridge(int* _fd, std::string _topicName, std::string _yarpPort);
