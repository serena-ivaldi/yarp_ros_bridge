...
{
    string path = "../src/iCub_MACSI/main/src/tools/yarp_ros_bridge_generator/src/to_ros_data_handler";
    mkdir(string(path+"/msg").c_str(),0775);
    ofstream msgFile(path+"/msg/Data.msg");
    if (msgFile.is_open())
    {
    ...
    mkdir(string(path+"/include").c_str(),0775);
    ofstream getter(path+"/include/generatedGetter.h");
    if (getter.is_open())
    {
